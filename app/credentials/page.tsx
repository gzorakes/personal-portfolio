            ...
            <CardContent>
              <div className="flex flex-col gap-10">
                <p>
                  ...
                  experience as a bouzouki and piano player shaped my
                  creativity, structure, and attention to detail.
                </p>
                <p>
                  I studied Computer Science and Multimedia at the University of
                  Heraklion and started programming with Python before moving
                  into full-stack web development. Today, I mainly work with
                  Next.js, React, TypeScript, and Node.js on modern web
                  applications.
                </p>
                <p>
                  I like building clean, responsive interfaces and making sure
                  the code behind them actually makes sense. I care about how
